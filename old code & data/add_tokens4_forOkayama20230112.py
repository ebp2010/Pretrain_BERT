...
SentencePieceTrainer.Train(
    '--input='+drive_dir+'corpus20230112.txt, --train_extremely_large_corpus=true --model_prefix='+drive_dir+'edogawa_sp --character_coverage=0.9995 --vocab_size=5150 --pad_id=3 --add_dummy_prefix=False --max_sentence_length=256'
...
corpus = open(drive_dir+"corpus20230112.txt", "r",encoding="utf-8_sig")
c = corpus.read()
