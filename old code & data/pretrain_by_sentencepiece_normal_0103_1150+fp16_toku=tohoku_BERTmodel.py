...
江戸川区用に語彙を追加したモデルでは３月21日に追加学習成功せず 
...
corpus_dir='D:/Edogawa/Edogawa_BERT/keikakiroku/corpus0319/corpus_with_blankline2.txt' 
...
model = BertModel.from_pretrained(config,use_auth_token=True)
...
modeldir = "D:/Edogawa/model_save/protection/model/"
...
training_args = TrainingArguments(
    ...
    fp16=True,
    # additional
    resume_from_checkpoint=modeldir,
    disable_tqdm=False,
