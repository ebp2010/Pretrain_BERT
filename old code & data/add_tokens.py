...
1)コーパスからspのトークナイザーを作成し、分かち書き、頻出順上位を抽出
"""
...
jp_text = "内夫に叩かれた本児は児童相談所に一時保護されたが、名前を言えない"
...
jtk_a.save_pretrained('D:/Edogawa/model_save/protection/token_edo_0319/')
