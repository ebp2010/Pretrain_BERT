...
drive_dir="D:/Edogawa/Edogawa_BERT/keikakiroku/"
...
CC_list = ['かもしれない','わからない','分からない','いけない','ことはない','ならない','ざるを得ない','いられない','かまわない','構わない','たまらない','てはいけない','いられない','ではないか','ならない','もらえない','ったらない','どころではない','過ぎない','足りない','違いない','ちがいない','とどまらない','及ばない','およばない','ほかならない','べくもない','こともない','までもない','ほかない','できない','出来ない','仕方ない','ない','ぬ','ん','非','不','無','未','反','異','無い','無し','物足りない','仕方がない','思わず','なければならない','ないといけない','かもしれません','にもかかわらず','だけでなく']
...
jtk_a = BertJapaneseTokenizer.from_pretrained("D:/Edogawa/model_save/protection/token_edo_0408/")
